      ...
      <section className="academy-explorer section-wrap" id="find-academy" tabIndex={-1}>
        <div className="container">
          ...
          <div className="academy-panel panel-presence" id="academy-panel-presence" role="tabpanel" aria-labelledby="academy-tab-presence" data-academy-panel="presence" tabIndex={0}>
            <div className="explorer-copy"><span className="panel-label">황정선 아카데미</span><h3>실력에 어울리는<br />첫인상과 태도.</h3><p>어떻게 보이고, 행동하고, 기억되는지.<br />나의 전문성과 역할에 맞는 이미지를 설계합니다.</p><div className="topic-tags"><span>리더 프레즌스</span><span>비즈니스 매너</span><span>이미지 전략</span></div><Link className="btn btn-primary" href="/appearance">프로그램 자세히 보기 <span aria-hidden="true">→</span></Link><Link className="explorer-director" href="/leaders">황정선 디렉터 소개 <span aria-hidden="true">↗</span></Link></div>
            {/* eslint-disable-next-line @next/next/no-img-element */}
