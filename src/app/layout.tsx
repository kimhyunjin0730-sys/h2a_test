...
export const metadata: Metadata = {
  ...
  icons: { icon: asset('assets/brand/site-icon-red.png'), apple: asset('assets/brand/site-icon-red.png') },
};
  ...
  return (
    <html lang="ko">
      <head>
        ...
        <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Noto+Sans+KR:wght@300;400;500;600;700&family=Outfit:wght@700&display=swap" />
      </head>
      <body>
