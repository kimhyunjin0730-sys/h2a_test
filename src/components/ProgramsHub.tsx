...
export default function ProgramsHub({ cat, title }: { cat: Cat; title: string }) {
  ...
  return (
    <div className="page-view active">
      ...
      {cat === 'appearance' ? <div className="container section-wrap text-center" style={{ paddingBottom: 0 }}><p className="body-large" style={{ fontWeight: 700, color: 'var(--ink)', marginBottom: '1rem' }}>성취를 브랜드로, 태도를 존재감으로, 만남을 관계 자산으로</p><p className="body-large">리더의 성과는 숫자로 증명되지만, 신뢰와 품격은 만나는 순간 읽힙니다.<br />황정선 아카데미는 한 사람의 철학과 성취가 제대로 전달되도록 브랜드·태도·관계의 전 과정을 설계합니다.</p><h2 className="section-title mt-xl" style={{ fontSize: '1.6rem', marginBottom: '2rem' }}>H2A PROGRAM JOURNEY</h2><div className="grid-3 text-left"><div className="card-basic" key="THE SIGNATURE"><span className="label-sm" style={{ color: 'var(--brand-red-dark)' }}>THE SIGNATURE</span><h4 className="eng-title" style={{ fontSize: '1.25rem', margin: '0.5rem 0 0.8rem' }}>나는 무엇을 대표하는가</h4><p style={{ color: 'var(--text-sub)', lineHeight: 1.8, fontSize: '0.95rem' }}>CEO 의 철학과 성취를 하나의 브랜드로 정의합니다.</p></div><div className="card-basic" key="THE CLASS ACT"><span className="label-sm" style={{ color: 'var(--brand-red-dark)' }}>THE CLASS ACT</span><h4 className="eng-title" style={{ fontSize: '1.25rem', margin: '0.5rem 0 0.8rem' }}>나는 어떻게 읽히는가</h4><p style={{ color: 'var(--text-sub)', lineHeight: 1.8, fontSize: '0.95rem' }}>브랜드가 신뢰와 품격, 정서적 영향력으로 전달되도록 훈련합니다.</p></div><div className="card-basic" key="THE TABLE"><span className="label-sm" style={{ color: 'var(--brand-red-dark)' }}>THE TABLE</span><h4 className="eng-title" style={{ fontSize: '1.25rem', margin: '0.5rem 0 0.8rem' }}>나는 무엇을 남기는가</h4><p style={{ color: 'var(--text-sub)', lineHeight: 1.8, fontSize: '0.95rem' }}>완성된 존재감을 실제 만남과 관계, 새로운 기회로 연결합니다.</p></div></div><p className="body-large" style={{ marginTop: '2.5rem', fontWeight: 700, color: 'var(--ink)' }}>브랜드를 세우고, 품격을 완성하며, 관계로 증명하다.</p></div> : null}
