...
const SLIDES = [
  ...
  { label: '황정선 아카데미', title: ['말하기 전부터,', '신뢰가 시작됩니다.'], desc: <>이미지와 태도, 매너와 관계.<br />나의 전문성에 어울리는 존재감을 설계합니다.</>, link: '/appearance', linkText: '외면소통 프로그램', src: asset('assets/stock/photo-1617761141732-d481912af1a9.jpg'), srcSet: `${asset('assets/stock/photo-1617761141732-d481912af1a9-800.jpg')} 800w, ${asset('assets/stock/photo-1617761141732-d481912af1a9.jpg')} 1600w`, pos: undefined, alt: '유리 외벽의 현대식 건물', source: 'Photo: Unsplash · Parrish Freeman' },
